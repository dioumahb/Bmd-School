    ...
    <div class="bg-white flex flex-col justify-start p-6">
        ...
        @if ($showAuthor)
            <p href="#" class="text-sm pb-3">
                Par <a href="#" class="font-semibold hover:text-gray-800">{{$post->user->name}}</a>, Publié le
        ...
        <a  href="{{route('view', $post)}}" class="uppercase text-gray-800 hover:text-black">Continuer la lecture <i
